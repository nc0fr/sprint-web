...
function pageOperations()
{
    ...
    <p><input type="text" class="input input-neutral input-bordered" name="nom" placeholder="Nom" >
    <input type="text" class="input input-neutral input-bordered" name="prenom" placeholder="Prénom" ></p>
    <p><input type="submit" class="btn btn-primary text-primary hover:text-primary-content" name="choixclientoperations" value="Valider"></p>';
    require_once 'Vue/gabaritAgent.php';
}
...
function pageSynthese()
{
    ...
    <p><input type="text" class="input input-neutral input-bordered" name="nom" placeholder="Nom" >
    <input type="text" class="input input-neutral input-bordered" name="prenom" placeholder="Prénom" ></p>
    <p><input class="btn btn-primary text-primary hover:text-primary-content" type="submit" name="clientsynthese" value="Synthèse client"></p>';
    require_once 'Vue/gabaritAgent.php';
}
